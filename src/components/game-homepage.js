        ...
        {openHowtoPlay && (
                          <div className="modal-wrapper" >
                            <div className="bg-gray-200 w-full h-full pb-10" style={{ overflowY: "auto" }}>
                              ...
                              <p className='fo font-bold text-left pl-10 pr-10 leading-10'>The game is simple. The game creator sets the number of rounds and chooses the word categories.
